...
namespace Alsing.Windows.Forms.SyntaxBox
{
    ...
    public class AutoListForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            LB = new Alsing.Windows.Forms.SyntaxBox.TabListBox();
            ...
            LB.Font = new System.Drawing.Font("Tahoma", 8.25F,
            ...
            LB.Name = "LB";
            LB.Size = new System.Drawing.Size(168, 184);
            LB.Sorted = true;
            LB.TabIndex = 0;
            LB.KeyDown += new System.Windows.Forms.KeyEventHandler
                (LB_KeyDown);
            LB.MouseDown += new System.Windows.Forms.MouseEventHandler
                (LB_MouseDown);
            LB.KeyPress += new System.Windows.Forms.KeyPressEventHandler
                (LB_KeyPress);
            LB.DoubleClick += new System.EventHandler(LB_DoubleClick);
            LB.KeyUp += new System.Windows.Forms.KeyEventHandler(LB_KeyUp);
            LB.SelectedIndexChanged += new System.EventHandler
                (LB_SelectedIndexChanged);
            LB.MouseMove += new System.Windows.Forms.MouseEventHandler
                (LB_MouseMove);
            LB.DrawItem += new System.Windows.Forms.DrawItemEventHandler
                (LB_DrawItem);
            //
            // tooltip
            //
            ...
            ClientSize = new System.Drawing.Size(168, 165);
            ...
            Resize += new System.EventHandler(AutoListForm_Resize);
            ResumeLayout(false);
        }
