...
namespace Irony.Compiler
{
    ...
    public class Scanner
    {
        ...
        #endregion Fields: _data, _source, _context, _caseSensitive, _currentToken
        ...
        private TokenEventArgs _tokenArgs = new TokenEventArgs(null);
        ...
        private TerminalList SelectTerminals(char current)
        {
            ...
            if (_data.TerminalsLookup.TryGetValue(current, out TerminalList result))
                return result;
            else
        ...
        #endregion TokenStart calculations
    }//class
}//namespace