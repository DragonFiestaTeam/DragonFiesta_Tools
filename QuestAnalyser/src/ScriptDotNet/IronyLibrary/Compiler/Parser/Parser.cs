...
namespace Irony.Compiler
{
    ...
    public class Parser
    {
        ...
        private IEnumerator<Token> _input;
        ...
        #endregion Properties and fields: Data, Stack, _context, Input, CurrentState, LineCount, TokenCount
        ...
        private TokenEventArgs _tokenArgs = new TokenEventArgs(null); //declare as field and reuse it to avoid generating garbage
        ...
        #endregion Events: ParserAction, TokenReceived
        ...
        private TokenList _previewBuffer = new TokenList();
        ...
        public AstNode Parse(CompilerContext context, IEnumerable<Token> tokenStream)
        {
            ...
            while (true)
            {
                ...
                OnActionSelected(_currentToken, action);
        ...
        private void ReportParserError()
        {
            ...
            string message = Data.Grammar.GetSyntaxErrorMessage(_context, expectedList);
            if (message == null)
        ...
        #endregion Error reporting and recovery
        ...
        protected void OnActionSelected(Token input, ActionRecord action)
        {
            ...
            {
                ParserActionEventArgs args = new ParserActionEventArgs(CurrentState, input, action);
        ...
        private void ExecuteReduceAction(ActionRecord action)
        {
            ...
            //switch to new state
            if (_currentState.Actions.TryGetValue(action.NonTerminal.Key, out ActionRecord gotoAction))
            {
