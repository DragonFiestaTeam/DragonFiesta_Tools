...
namespace Irony.Compiler
{
    ...
    {
        private class ShiftTable : Dictionary<string, LR0ItemList>
        { }
        ...
        private void BuildTerminalsLookupTable()
        {
            ...
            foreach (Terminal term in Data.Terminals)
            {
                ...
                foreach (string prefix in prefixes)
                {
                    ...
                    if (!Data.TerminalsLookup.TryGetValue(hashKey, out TerminalList currentList))
                    {
        ...
        #endregion Collecting non-terminals
        ...
        #endregion Creating Productions
        ...
        #endregion Nullability calculation
        ...
        private void CalculateFirsts()
        {
            ...
            foreach (Production prod in Data.Productions)
            {
                ...
                {
                    if (term is Terminal)
                    { //it is terminal, so add it to Firsts and that's all with this production
        ...
        private void CalculateTailFirsts()
        {
            foreach (Production prod in Data.Productions)
            {
                ...
                for (int i = prod.LR0Items.Count - 1; i >= 0; i--)
                {
                    ...
                    { //term is a terminal or non-nullable NonTerminal
        ...
        #endregion Calculating Tail Firsts
        ...
        private void CreateInitialAndFinalStates()
        {
            ...
            #endregion comment about FinalState
        ...
        private ShiftTable GetStateShifts(ParserState state)
        {
            ...
            foreach (LRItem item in state.Items)
            {
                ...
                if (!shifts.TryGetValue(term.Key, out LR0ItemList list))
        ...
        private ParserState FindOrCreateState(LR0ItemList lr0Items)
        {
            ...
            if (_stateHash.TryGetValue(key, out ParserState result))
                return result;
        ...
        private bool AddClosureItems(ParserState state)
        {
            ...
            for (int i = 0; i < state.Items.Count; i++)
            {
                ...
                foreach (Production prod in nextNT.Productions)
                {
                    ...
                    #endregion Comments on lookaheads processing
        ...
        #endregion Creating parser states
        ...
        #endregion Lookaheads propagation
        ...
        private void CreateReduceActions()
        {
            foreach (ParserState state in Data.States)
            {
                foreach (LRItem item in state.Items)
                {
                    ...
                    {
                        if (state.Actions.TryGetValue(lookahead, out ActionRecord action))
        ...
        #endregion Final actions: createReduceActions
        ...
        private void AddErrorForInput(StringDictionary errors, string input, string template, params object[] args)
        {
            ...
            errors.TryGetValue(msg, out string tmpInputs);
        ...
        #endregion Check for shift-reduce conflicts
        ...
        #endregion error handling: AddError
    }//class
}//namespace