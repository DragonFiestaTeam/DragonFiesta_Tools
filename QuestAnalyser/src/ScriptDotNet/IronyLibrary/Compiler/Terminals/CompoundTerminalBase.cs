...
namespace Irony.Compiler
{
  ...
  */
    ...
    public abstract class CompoundTerminalBase : Terminal
    {
        ...
        private string _prefixesFirsts; //first chars of all prefixes, for fast prefix detection
        private string _suffixesFirsts; //first chars of all suffixes, for fast suffix detection
        ...
        #endregion events: ConvertingValue
        ...
        protected virtual void ReadPrefix(ISourceStream source, ScanDetails details)
        {
            ...
            foreach (string pfx in Prefixes)
            {
                ...
                if (!string.IsNullOrEmpty(details.Prefix) && PrefixFlags.TryGetValue(details.Prefix, out ScanFlags pfxFlags))
