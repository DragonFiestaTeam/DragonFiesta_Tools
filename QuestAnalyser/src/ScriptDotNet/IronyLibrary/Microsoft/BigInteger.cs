...
namespace Microsoft.Scripting.Math
{
    ...
    public class BigInteger : IFormattable, IComparable, IConvertible
    {
        ...
        private class TypeConvertor : System.ComponentModel.TypeConverter
        {
        ...
        public static BigInteger operator /(BigInteger x, BigInteger y)
        {
            return DivRem(x, y, out BigInteger dummy);
        }
        ...
        public static BigInteger DivRem(BigInteger x, BigInteger y, out BigInteger remainder)
        {
            ...
            DivModUnsigned(x.data, y.data, out uint[] q, out uint[] r);
        ...
        {
            if (AsUInt32(out uint ret) && (ret & ~0xFF) == 0)
            {
                return (byte)ret;
            }
        ...
        {
            if (AsInt32(out int ret) && (ret <= Char.MaxValue) && (ret >= Char.MinValue))
            {
                return (char)ret;
            }
        ...
        {
            if (AsInt32(out int ret) && (ret <= short.MaxValue) && (ret >= short.MinValue))
            {
                return (short)ret;
            }
        ...
        {
            if (AsInt32(out int ret) && (ret <= sbyte.MaxValue) && (ret >= sbyte.MinValue))
            {
                return (sbyte)ret;
            }
