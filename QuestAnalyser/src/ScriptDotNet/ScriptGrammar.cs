...
namespace ScriptNET
{
    ...
    public class ScriptdotnetGrammar : Grammar
    {
        public ScriptdotnetGrammar(bool expressionGrammar)
        {
            ...
            #endregion 2.4 Program and Functions

            #endregion 2. Non-terminals
            ...
            #endregion 4. Set starting symbol
            ...
            #endregion 5. Operators precedence

            #region 6. Punctuation symbols

            RegisterPunctuation("(", ")", "[", "]", "{", "}", ",", ";");

            #endregion 6. Punctuation symbols
        }
