...
namespace QuestDataAnalyser
{
    public sealed class ScriptAPI
    {
        ...
        public void AddScript(string pName)
        {
            mStructure.APIAddScript(pName);
        }
        ...
        public void AddNulledString(string pName)
        {
            mStructure.APINulledString(pName);
        }
